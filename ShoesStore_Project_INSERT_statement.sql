...
('00000000-0000-0000-0000-000000000002', 'staff@solelab.com', '123456', '33333333-3333-3333-3333-333333333333', 'Staff SoleLab');
...
-- Air Max Pulse (Product 1)
(NEWID(), '10000000-0000-0000-0000-000000000001', '39', 'Black', 50, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000001', '40', 'Black', 45, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000001', '41', 'Black', 30, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000001', '39', 'White', 20, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000001', '40', 'White', 26, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000001', '41', 'White', 15, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000001', '42', 'White', 10, SYSDATETIMEOFFSET()),

-- Ultraboost Light (Product 2)
(NEWID(), '10000000-0000-0000-0000-000000000002', '39', 'Black', 40, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000002', '40', 'Black', 50, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000002', '41', 'Black', 35, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000002', '42', 'Black', 30, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000002', '40', 'White', 25, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000002', '41', 'White', 30, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000002', '42', 'White', 15, SYSDATETIMEOFFSET()),

-- Puma MB.02 (Product 3)
(NEWID(), '10000000-0000-0000-0000-000000000003', '40', 'White', 30, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000003', '41', 'White', 30, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000003', '42', 'White', 25, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000003', '41', 'Red', 15, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000003', '42', 'Red', 20, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000003', '43', 'Red', 10, SYSDATETIMEOFFSET()),

-- Air Force 1 '07 (Product 4)
(NEWID(), '10000000-0000-0000-0000-000000000004', '39', 'Red', 20, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000004', '40', 'Red', 20, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000004', '41', 'Red', 20, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000004', '42', 'Red', 20, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000004', '39', 'White', 50, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000004', '40', 'White', 50, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000004', '41', 'White', 50, SYSDATETIMEOFFSET()),
(NEWID(), '10000000-0000-0000-0000-000000000004', '42', 'White', 40, SYSDATETIMEOFFSET());
