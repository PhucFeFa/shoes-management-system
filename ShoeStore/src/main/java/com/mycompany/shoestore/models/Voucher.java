...
public class Voucher implements Serializable {
    ...
    public Voucher(String id, String code, String discountType, BigDecimal discountValue, BigDecimal maxDiscountAmount, OffsetDateTime startDate, OffsetDateTime endDate, int quantity, int usedQuantity) {
        this.id = id;
        this.code = code;
