...
<title>Adidis - Authentication</title>
...
<a class="text-label-sm font-label-sm text-secondary hover:text-primary underline underline-offset-4 transition-colors" href="#" onclick="showOTP()">FORGOT PASSWORD?</a>
</div>
<div class="relative">
...
<button class="w-full bg-primary text-on-primary py-5 text-label-md font-label-md uppercase tracking-widest hover:bg-primary/90 transition-colors" type="button">
                            VERIFY CODE
                        </button>
<button class="w-full bg-transparent text-secondary py-4 text-label-sm font-label-sm uppercase tracking-widest hover:text-primary transition-colors" onclick="cancelOTP()" type="button">
                            CANCEL
                        </button>
</div>
</div>
