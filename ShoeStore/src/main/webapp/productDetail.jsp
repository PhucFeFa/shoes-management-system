        ...
        <div class="bg-white rounded-2xl shadow-lg border p-10">
            ...
            <div class="flex flex-col justify-center">
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex">
                        <span class="font-semibold w-32">Brand:</span>
                ...
                <div class="flex items-center gap-4 mt-4">
                    ...
                    <form action="${pageContext.request.contextPath}/AddToCart"
                        ...
                        <button id="addToCartBtn"
                                type="submit"
                                disabled
                                class="bg-black text-white px-8 py-4 rounded-lg hover:bg-gray-800 transition disabled:opacity-50">
...
colorSelect.addEventListener("change", function() {
    ...
    if (variant.stock <= 0) {
        ...
        stockInfo.innerHTML =
            '<span class="text-green-600">Available: ' +
            variant.stock +
            ' items</span>';
