        ...
        <div class="px-16 py-10 flex-1">
            <form action="${pageContext.request.contextPath}/staff/create-import" method="POST" id="importForm" class="max-w-6xl" onsubmit="return validateForm()">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-12 py-4 bg-black text-white font-bold uppercase text-xs tracking-widest rounded-full hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl active:scale-95">
                        Submit Request
                    </button>
                </div>
            </form>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all">
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <select id="modalProduct" onchange="onProductChange()" class="w-full border-gray-200 rounded-2xl focus:ring-black focus:border-black text-sm py-3 px-4">
                ...
                <div class="space-y-2">
                    ...
                    <select id="modalSize" disabled onchange="onSizeChange()" class="w-full border-gray-200 rounded-2xl focus:ring-black focus:border-black text-sm py-3 px-4 disabled:bg-gray-50 disabled:text-gray-400">
                ...
                <div class="space-y-2">
                    ...
                    <select id="modalColor" disabled class="w-full border-gray-200 rounded-2xl focus:ring-black focus:border-black text-sm py-3 px-4 disabled:bg-gray-50 disabled:text-gray-400">
            ...
            <div class="px-8 py-6 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
                ...
                <button type="button" onclick="confirmAddVariant()" class="px-6 py-2.5 bg-black text-white text-xs font-bold uppercase tracking-widest rounded-full hover:bg-gray-800 transition-all shadow-md active:scale-95">Add to List</button>
            </div>
        </div>
    </div>
