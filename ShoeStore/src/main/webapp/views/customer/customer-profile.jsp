                        ...
                        <header
                            ...
                            <div class="flex gap-4">
                                <a href="${pageContext.request.contextPath}/logout"
                                    class="px-6 py-3 border border-outline-variant text-secondary font-label-md text-label-md uppercase hover:bg-surface-container-low transition-colors flex items-center gap-2">
