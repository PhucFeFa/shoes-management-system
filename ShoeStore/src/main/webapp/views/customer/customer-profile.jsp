                    ...
                    <main class="ml-64 flex-1 flex flex-col min-h-screen">
                        ...
                        <section class="px-margin-desktop py-12 flex-1 max-w-5xl">
                            ...
                            <c:if test="${not empty sessionScope.profileSuccessMessage}">
                                <div class="mb-8 p-4 bg-surface-container text-primary border border-outline-variant/50 font-label-md flex items-center gap-3 rounded-2xl">
                            ...
                            <c:if test="${not empty sessionScope.profileErrorMessage}">
                                <div class="mb-8 p-4 bg-error-container border border-error/20 text-on-error-container font-label-md flex items-center gap-3 rounded-2xl">
                                    <span class="material-symbols-outlined">error</span>
                                    ${sessionScope.profileErrorMessage}
                                </div>
                                <c:remove var="profileErrorMessage" scope="session"/>
                            </c:if>

                            <!-- User Information -->
                            <div class="border border-outline-variant bg-surface p-8 mb-12 shadow-sm rounded-2xl">
                                <h3
                                ...
                                <form action="${pageContext.request.contextPath}/profile/change-password" method="POST" class="max-w-md space-y-6">
                                    <div>
                                        ...
                                        <input type="password" id="oldPassword" name="oldPassword" required
                                            class="w-full bg-surface-container-lowest border border-outline-variant text-primary font-body-md text-body-md px-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary transition-shadow placeholder:text-secondary/50 rounded-full"
                                    ...
                                    <button type="submit"
                                        class="w-full bg-primary text-on-primary font-label-md text-label-md uppercase tracking-widest py-4 hover:opacity-90 active:scale-[0.98] transition-all rounded-full">
                                        Update Password
                                    </button>
                                </form>
                            </div>
