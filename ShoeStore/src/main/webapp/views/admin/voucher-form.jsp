...
<head>
    ...
    <style>
        ...
        .form-control, .form-select { border-radius: 4px; border: 1px solid #e0e0e0; padding: 10px 14px; font-size: 14px; color: #1a1a1a; }
            ...
            <div class="content-container">
                ...
                <div class="form-card">
                    <c:if test="${not empty ERROR}">
                        <div class="alert alert-danger" style="font-size: 13px; border-radius: 4px; padding: 12px 16px; margin-bottom: 24px;">
