        ...
        <div class="d-flex">
            ...
            <div class="main-content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3" style="min-height: 38px;">
                    <form action="${pageContext.request.contextPath}/admin/manage-categories" method="GET" class="input-group" style="width: 300px;">
                        ...
                        <input type="text" name="search" value="${searchQuery}" class="form-control border-start-0" placeholder="Search category name..." style="font-size: 13px; border-top-right-radius: 50px; border-bottom-right-radius: 50px; padding-right: 14px;">
                ...
                <div class="table-card">
                    ...
                    <div class="pagination-footer">
                        <span class="pagination-info">Showing ${rangeStart}-${rangeEnd} of ${totalCategories} categories</span>
                        <div class="pagination-controls">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="${pageContext.request.contextPath}/admin/manage-categories?page=${currentPage - 1}${not empty searchQuery ? '&search=' : ''}${not empty searchQuery ? searchQuery : ''}" class="page-btn"><i class="bi bi-chevron-left"></i></a>
                                </c:otherwise>
                            </c:choose>
...
<c:if test="${startPage > 1}">
    ...
    <c:choose>
                                    ...
                                    <c:otherwise>
                                        <a href="${pageContext.request.contextPath}/admin/manage-categories?page=${p}${not empty searchQuery ? '&search=' : ''}${not empty searchQuery ? searchQuery : ''}" class="page-btn"><c:out value="${p}" /></a>
                                    </c:otherwise>
                                </c:choose>
...
<c:if test="${endPage < totalPages}">
    ...
    <c:choose>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="${pageContext.request.contextPath}/admin/manage-categories?page=${currentPage + 1}${not empty searchQuery ? '&search=' : ''}${not empty searchQuery ? searchQuery : ''}" class="page-btn"><i class="bi bi-chevron-right"></i></a>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
