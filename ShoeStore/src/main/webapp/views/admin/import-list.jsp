...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* Table */
        .import-table { width: 100%; border-collapse: collapse; table-layout: fixed; }
        .import-table thead tr { border-bottom: 2px solid #e8e8e8; }
        .import-table thead th {
            font-size: 9px; font-weight: 700; letter-spacing: .14em;
            text-transform: uppercase; color: #999;
            padding: 14px 16px; white-space: nowrap; overflow: hidden;
        }
        .import-table tbody tr { border-bottom: 1px solid #f0f0f0; transition: background .12s; }
        .import-table tbody tr:last-child { border-bottom: none; }
        .import-table tbody tr:hover { background: #fafafa; }
        .import-table tbody td {
            padding: 16px 16px; font-size: 13px; color: #1a1a1a;
            vertical-align: middle; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
        }

        /* Col widths */
        .col-id       { width: 9%; }
        .col-created  { width: 26%; }
        ...
        .cell-id       { font-size: 13px; font-weight: 700; color: #1a1a1a; }
        .cell-muted    { font-size: 12px; color: #bbb; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: block; }
        .cell-supplier { font-weight: 600; color: #1a1a1a; }
        .cell-amount   { font-weight: 700; color: #1a1a1a; }
        .cell-date     { font-size: 12px; color: #888; }

        /* Badges */
        .status-badge { font-size: 9px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; padding: 4px 10px; display: inline-block; white-space: nowrap; }
        .badge-completed { background: #e6f4ea; color: #2d7a3a; }
        .badge-shipping  { background: #fff8e1; color: #b08000; }
        .badge-default   { background: #f0f0f0; color: #888; }

        /* View button */
        .btn-view { display: inline-block; font-size: 9px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; padding: 6px 14px; border: 1px solid #1a1a1a; color: #1a1a1a; text-decoration: none; white-space: nowrap; transition: background .15s, color .15s; }
