            ...
            <main class="pt-16">
                ...
                <section
                    ...
                    <div class="relative z-10 px-margin-mobile md:px-margin-desktop w-full max-w-container-max mx-auto">
                        <div class="max-w-xl">
                            <p class="text-label-md font-label-md uppercase tracking-widest text-primary mb-4">ADIDIS //
                                INITIATIVE 01</p>
                            <h1
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter">
                        ...
                        <c:forEach var="product" items="${latestProducts}">
                            <div
                                ...
                                <div>
                                    <h3 class="text-label-md font-label-md font-bold uppercase mb-1">${product.name}
                                    </h3>
                ...
                <section class="py-24 bg-surface-container-high px-margin-mobile md:px-margin-desktop">
                    <div class="max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
                        <div>
                            ...
                            <p class="text-body-lg text-on-surface-variant mb-8 max-w-md">Join the ADIDIS community to
                                get
