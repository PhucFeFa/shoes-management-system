...
<!-- REGISTER FORM -->
<form class="flex flex-col space-y-6 w-full transition-opacity duration-300 <c:if test='${showOTP}'>hidden opacity-0</c:if>" id="form-register" action="${pageContext.request.contextPath}/register" method="POST">
<div class="flex flex-col space-y-2">
<label class="text-label-sm font-label-sm uppercase text-secondary" for="register-fullname">Full Name</label>
<input class="w-full bg-surface-container text-body-md font-body-md text-primary border-none p-4 rounded-none focus:ring-2 focus:ring-primary focus:outline-none placeholder:text-secondary/50 transition-shadow" id="register-fullname" name="fullName" placeholder="ALEX MERCER" type="text" required/>
</div>
<div class="flex flex-col space-y-2">
<label class="text-label-sm font-label-sm uppercase text-secondary" for="register-email">Email Address</label>
<input class="w-full bg-surface-container text-body-md font-body-md text-primary border-none p-4 rounded-none focus:ring-2 focus:ring-primary focus:outline-none placeholder:text-secondary/50 transition-shadow" id="register-email" name="email" placeholder="ENTER EMAIL" type="email" required/>
</div>
<div class="flex flex-col space-y-2">
<label class="text-label-sm font-label-sm uppercase text-secondary" for="register-password">Password</label>
<input class="w-full bg-surface-container text-body-md font-body-md text-primary border-none p-4 rounded-none focus:ring-2 focus:ring-primary focus:outline-none placeholder:text-secondary/50 transition-shadow" id="register-password" name="password" placeholder="••••••••" type="password" required/>
</div>
<div class="flex flex-col space-y-2">
<label class="text-label-sm font-label-sm uppercase text-secondary" for="register-confirm">Confirm Password</label>
<input class="w-full bg-surface-container text-body-md font-body-md text-primary border-none p-4 rounded-none focus:ring-2 focus:ring-primary focus:outline-none placeholder:text-secondary/50 transition-shadow" id="register-confirm" name="confirmPassword" placeholder="••••••••" type="password" required/>
</div>
...
<div class="pt-4 text-center"><a class="text-label-sm font-label-sm text-secondary hover:text-primary transition-colors uppercase tracking-widest" href="${pageContext.request.contextPath}/login">Already have an account? Log in</a></div>
</form>
...
<form action="${pageContext.request.contextPath}/verify-otp" method="POST" id="verify-form">
    ...
    <div class="flex flex-col space-y-4 pt-4">
        ...
        <a href="${pageContext.request.contextPath}/register" class="text-center w-full bg-transparent text-secondary py-4 text-label-sm font-label-sm uppercase tracking-widest hover:text-primary transition-colors">
            CANCEL
        </a>
    </div>
</form>
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-mobile md:px-margin-desktop w-full max-w-container-max mx-auto">
...
<div class="col-span-1 md:col-span-4 flex flex-wrap gap-8 items-center justify-between border-t border-on-primary/20 pt-8">
<span class="text-label-sm font-label-sm text-on-primary/70">© 2024 Adidis. ENGINEERED SPEED.</span>
<nav class="flex gap-6 flex-wrap">
<a class="text-label-sm font-label-sm text-on-primary/70 hover:text-on-primary transition-colors uppercase" href="#">ABOUT US</a>
<a class="text-label-sm font-label-sm text-on-primary/70 hover:text-on-primary transition-colors uppercase" href="#">CUSTOMER SERVICE</a>
<a class="text-label-sm font-label-sm text-on-primary/70 hover:text-on-primary transition-colors uppercase" href="#">TERMS</a>
<a class="text-label-sm font-label-sm text-on-primary/70 hover:text-on-primary transition-colors uppercase" href="#">INSTAGRAM</a>
<a class="text-label-sm font-label-sm text-on-primary/70 hover:text-on-primary transition-colors uppercase" href="#">TWITTER</a>
</nav>
</div>
</div>
</footer>
